...
angular.module('servisApp')
    .controller('ViewbackCtrl', function($scope, $http, $route, authService, $location) {
        ...
        $scope.exportData = function () {
            ...
            alasql('SELECT id as ID, fname as Ime, lname as Prezime, tel as Telefon, type as Tip, model as Model, issue as Problem, price as Cena, imei as IMEI, status as Status INTO XLSX("IzvestajVrateni.xlsx",{headers:true}) FROM ?',[$scope.data]);
        };
    });